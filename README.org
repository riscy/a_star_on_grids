...
\begin{comment}
#+end_export
[[https://github.com/riscy/a_star_on_grids/actions][https://github.com/riscy/a_star_on_grids/workflows/test/badge.svg]] [[https://github.com/riscy/a_star_on_grids/raw/main/pdf/a_star_on_grids.pdf][https://img.shields.io/badge/download-pdf-orange.svg]] [[https://img.shields.io/badge/version-20180602-blue.svg]]
...
* Description
  ...
  Some accompanying [[https://github.com/riscy/a_star_on_grids/tree/main/src][example code]] is available in C++.
* Preliminaries
...
** Use octile distance on an 8-connected grid
   ...
   - See an [[https://github.com/riscy/a_star_on_grids/blob/main/src/heuristics.cpp#L59][example implementation of the octile heuristic]]
   - See an [[https://github.com/riscy/a_star_on_grids/blob/main/src/heuristics.cpp#L67][example implementation of the non-branching octile heuristic]]
** Scale your heuristics up
   ...
   See an [[https://github.com/riscy/a_star_on_grids/blob/main/src/heuristics.cpp#L74][example implementation of a weighted octile heuristic]].
* Algorithmic details
...
** Break ties in favor of path depth
   ...
   See [[https://github.com/riscy/a_star_on_grids/blob/main/src/node_heap.h#L9][example tiebreaking code]].
** Avoid recomputing heuristics
   ...
   See [[https://github.com/riscy/a_star_on_grids/blob/main/src/algorithms.cpp#L119][an example of using memoized heuristics]].
** Know whether to use a heap
   ...
   - See an [[https://github.com/riscy/a_star_on_grids/blob/main/src/algorithms.cpp#L38][A* implementation that uses an array]]
   - See an [[https://github.com/riscy/a_star_on_grids/blob/main/src/algorithms.cpp#L90][A* implementation that uses a heap]]
   - See an [[https://github.com/riscy/a_star_on_grids/blob/main/src/node_heap.h][example heap implementation]]
** Consider Fringe Search
   ...
   See [[https://github.com/riscy/a_star_on_grids/blob/main/src/algorithms.cpp#L140][an example Fringe Search implementation]].
* Implementation
