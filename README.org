...
\begin{comment}
#+end_latex
[[https://github.com/riscy/a_star_on_grids/raw/master/pdf/a_star_on_grids.pdf][https://img.shields.io/badge/download-pdf-orange.svg]] [[https://img.shields.io/badge/version-20180304-blue.svg]]
...
* Heuristics
  I frequently see these details missed on many first implementations of A*.
...
* Implementation details
  These details tend not to come up in textbook descriptions of A*.
